...
const ProductCard = ({ id }) => {
  return (
    ...
    >
      {/* Image */}
      <Link href={`/#${id}`}>
        <div className="bg-gray-500 w-full h-[200px] sm:h-[300px] rounded-t-md relative overflow-hidden">
          <Image
            src={"/product.png"}
            fill
            alt="Product Image"
      ...
      <div className="px-2 sm:px-4 py-2">
        <Link href={"/"}>
          <h1 className="text-md sm:text-lg font-semibold hover:underline">
            Product Name
          </h1>
        </Link>
